...
import fi.septicuss.tooltips.managers.condition.impl.lookingat.*;
import fi.septicuss.tooltips.managers.condition.impl.player.*;
...
import fi.septicuss.tooltips.managers.preset.functions.impl.*;
...
import fi.septicuss.tooltips.pack.impl.*;
